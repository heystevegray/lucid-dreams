...
var handleType = function (type) {
    ...
    if (typeLowercase.includes('varchar')) {
        ...
        return "String " + constants_1.prismaDatabaseTypes.varchar + "(" + charLength + ")";
    }
    if (typeLowercase.includes('char')) {
        var charLength = parseCharacterCount(type, 'char'.length);
        return "String " + constants_1.prismaDatabaseTypes.char + "(" + charLength + ")";
    }
    if (typeLowercase.includes('datetime') ||
...
var cleanup = function (inputFile) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                try {
                    ...
                    },
                    {
                        ...
                        task: function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        schema = exports.parseLucidChart(ctx.results);
